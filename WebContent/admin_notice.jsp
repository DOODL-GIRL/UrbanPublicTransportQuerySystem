...
<body>
    <div class="container">
    	<div class="top-wrapper">
            <div class="header">
                <span style="font-family: 'Arial', sans-serif; letter-spacing: 3px;">公告管理</span>
            </div>
        ...
        <div class="content-wrapper">
            <div class="table-wrapper">
            	<div class="button_wrapper">
            		<form action="/UrbanPublicTransportQuerySystem/admin_notice" method="post">
                		<input type="submit" value="查询" class="query-button">
                	</form>
            		<button class="add-button">添加公告</button>
            		<button class="delete-button">删除公告</button>
    ...
    <div id="addUserDialog" class="add-dialog" style="display: none;text-align:center">
        <h2 style="margin-bottom:20px;">添加公告</h2>
        <input type="text" id="noticetitle" placeholder="公告标题">
        <input type="text" id="noticecontent" placeholder="公告内容">
        <input type="text" id="noticetime" placeholder="公告时间">
        <button id="addUserButton">确定</button>
        <button class="cancel-button">取消</button>
    </div>
	<div id="deleteUserDialog" class="add-dialog" style="display: none;text-align:center">
	    <h2 style="margin-bottom:20px;">删除公告</h2>
	    <input type="text" id="noticeId" placeholder="公告编号">
    ...
    <script>
        ...
        document.getElementById('addUserButton').addEventListener('click', function() {
          ...
          //将对话框中填写的值作为请求参数添加到URL中
            window.location.href = 'notice_add?noticetitle=' + encodeURIComponent(noticetitle) + '&noticecontent=' + encodeURIComponent(noticecontent) + '&noticetime=' + encodeURIComponent(noticetime);
     ...
     // 删除对话框确定按钮的代码
        document.getElementById('deleteUserButton').addEventListener('click', function() {
            ...
            //将对话框中填写的值作为请求参数添加到URL中
            window.location.href = 'notice_delete?noticeId=' + encodeURIComponent(noticeId);
